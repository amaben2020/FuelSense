...
import { db, vehicleCertificates, vehicles, drivers, eq, and, desc, sql } from '../lib/db-helpers';
import { CERTIFICATE_KINDS, type CertificateKind } from '../db/schema';
import { scanVioCertificate } from '../lib/vio-certificate';
