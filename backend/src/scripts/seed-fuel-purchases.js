...
const { db, initDatabase, closePool } = require('../config/db');
const { customers, fuelPurchases } = require('../config/db/schema');
const { eq, sql } = require('drizzle-orm');
const { REFUEL_THRESHOLD_LITERS, DEFAULT_FUEL_PRICE_NGN_LITER } = require('../features/fuel/fuel-metrics.service');
const { findObdRefuelMatch } = require('../features/receipts/receipt-reconciliation.service');
