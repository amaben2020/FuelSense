...
const { db, vehicles, devices, telemetry, alerts, siphonEvents, eq, and, sql } = require('../shared/db-helpers');
const { detectAnomalies, resetEngineState } = require('../features/fuel/anomaly-detector.service');
