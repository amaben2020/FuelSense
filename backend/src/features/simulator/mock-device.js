...
const { lastKnownPosition } = require('../tracker/last-known-position.service');
...
// tracker/sim-origin.service.ts for the precedence rules). Previously this file hardcoded a
