...
const { VehicleSimulator, DEFAULT_FLEET_PROFILES } = require('./simulator');
const { lastKnownPosition, lastKnownReadings } = require('../tracker/last-known-position.service');
const { resolveOrigin, envOrigin } = require('../tracker/sim-origin.service');
const { decodeCodec12Command, encodeCodec12Response } = require('../tracker/codec12.service');
