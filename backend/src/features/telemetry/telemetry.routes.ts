...
import { subscribeLivePoints } from './live-feed.service';
import { authenticateCustomer } from '../auth/auth.middleware';
import { db, telemetry, vehicles, fuelPurchases, eq, and, desc, sql } from '../../shared/db-helpers';
import { withCache, invalidate, cacheKey } from '../../config/redis';
import { fleetEfficiencyAggSql } from './fleet-efficiency.repository';
import { dailyActivitySql } from './daily-activity.repository';
import { buildDailyActivityReplay } from './event-replay.service';
import { segmentTrips, TelemetryTripPoint, TripStop } from './trip-segmentation.service';
import {
  CO2_KG_PER_LITER,
  round1,
  round2,
