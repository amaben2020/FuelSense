...
import { db, alerts, vehicles, drivers, eq, and, desc } from '../../shared/db-helpers';
import { inArray, isNotNull, isNull, sql } from 'drizzle-orm';
import { alertDefinition, MANAGER_ACTIONS, type ManagerAction } from './alert-catalogue.service';
